...
public:
	...
	void  Update(float dt, entity_type* other)const
	{
		//if a global state exists, call its execute method, else do nothing
		if (m_pGlobalState)   m_pGlobalState->Execute(m_pOwner,other,dt);

		//same for the current state
		if (m_pCurrentState) m_pCurrentState->Execute(m_pOwner,other,dt);
	}
